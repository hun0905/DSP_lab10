...
cutoff_frequency = 1; %This is the standard deviation, in spatial domain, of the 
...
low_frequencies = image1-my_imfilter(image1, filter);
...
figure(3); imshow(vis);
imwrite(low_frequencies, '../results/low_frequencies_reverse.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, '../results/high_frequencies_reverse.jpg', 'quality', 95);
imwrite(hybrid_image, '../results/hybrid_image_reverse.jpg', 'quality', 95);
imwrite(vis, '../results/hybrid_image_scales_reverse.jpg', 'quality', 95);
